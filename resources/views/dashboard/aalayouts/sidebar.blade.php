    ...
    <nav class="" id="sidebarMenu">
        <div class="pt-6">
            <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link"
                       id="report-tab0"  type="button" href="/">
                       <i class="fas fa-chart-bar fa-fw me-3"></i><span>گزارش کار</span>
                    </a>
                    <ul class="absolute-menu submenu">
                        <li><a href="/reports/all">گزارش کارها</a></li>
                        <li><a href="/reports/add-report">افزودن گزارش کار</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
