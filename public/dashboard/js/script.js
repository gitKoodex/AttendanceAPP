$(function(){
    ...
    function siteUrl(){
        var first = $(location).attr('origin');
        return first;
    }
    $("#registerModalForm").submit(function (){

        var path= siteUrl()+"/register";
        console.log(path);
...
$("#exampleModal [data-mdb-dismiss=modal]").on("click",function (){
    location.reload();
});
$("#registereModal [data-mdb-dismiss=modal]").on("click",function (){
    location.reload();
});
